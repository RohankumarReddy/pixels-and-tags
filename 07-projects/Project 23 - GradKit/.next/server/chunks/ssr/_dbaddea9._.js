...
function AICoverLetterPage() {
    ...
    const handleGenerate = async ()=>{
        ...
        setLoading(true);
        try {
            const letter = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$coverletter$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateCoverLetter"])(input);
...
function AICoverLetter() {
    ...
    const handleGenerate = async ()=>{
        ...
        setLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$coverletter$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateCoverLetter"])(input);
            setOutput(result);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Cover letter generated!");
        } catch (error) {
            console.error(error);
...
//# sourceMappingURL=_dbaddea9._.js.map