...
async function updateUser(data) {
    ...
    try {
            ...
            if (!industryInsight) {
                industryInsight = await tx.industryInsight.create({
                    data: {
                        ...
                        demandLevel: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["DemandLevel"].Medium,
                        topSkills: [],
                        // FIX: Use the enum with the correct casing
                        marketOutlook: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MarketOutlook"].Neutral,
                        keyTrends: [],
                        recommendedSkills: [],
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/"); // Revalidate after transaction
        return {
            success: true,
            ...result
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac87cbd7._.js.map