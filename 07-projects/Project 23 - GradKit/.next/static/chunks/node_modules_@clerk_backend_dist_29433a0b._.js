...
var MachineTokenVerificationError = class _MachineTokenVerificationError extends Error {
    getFullMessage() {
        return "".concat(this.message, " (code=").concat(this.code, ", status=").concat(this.status, ")");
    }
...
var assertHeaderType = (typ)=>{
    ...
    if (typ !== "JWT") {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$HNJNM32R$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenVerificationError"]({
            ...
            message: "Invalid JWT type ".concat(JSON.stringify(typ), '. Expected "JWT".')
        });
    }
};
...
"[project]/node_modules/@clerk/backend/dist/chunk-S7Q4VL6O.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var createRedirect = (params)=>{
    ...
    const redirectToTasks = (url, param)=>{
        ...
        return redirectAdapter(buildUrl(baseUrl, "".concat(url, "/tasks"), returnBackUrl, isDevelopment ? params.devBrowserToken : null));
    };
...
var SamlAccount = class _SamlAccount {
    static fromJSON(data) {
        var _data_last_authenticated_at;
        return new _SamlAccount(data.id, data.provider, data.provider_user_id, data.active, data.email_address, data.first_name, data.last_name, data.verification && Verification.fromJSON(data.verification), data.saml_connection && SamlAccountConnection.fromJSON(data.saml_connection), (_data_last_authenticated_at = data.last_authenticated_at) !== null && _data_last_authenticated_at !== void 0 ? _data_last_authenticated_at : null, data.enterprise_connection_id);
    }
...
var BillingSubscriptionItem = class _BillingSubscriptionItem {
    static fromJSON(data) {
        ...
        var _data_plan_id;
        return new _BillingSubscriptionItem(data.id, data.status, data.plan_period, data.period_start, data.next_payment, formatAmountJSON(data.amount), data.plan ? BillingPlan.fromJSON(data.plan) : null, (_data_plan_id = data.plan_id) !== null && _data_plan_id !== void 0 ? _data_plan_id : null, data.created_at, data.updated_at, data.period_end, data.canceled_at, data.past_due_at, data.ended_at, data.payer_id, data.is_free_trial, formatAmountJSON(data.lifetime_paid));
    }
...
var BillingSubscription = class _BillingSubscription {
    static fromJSON(data) {
        ...
        var _data_active_at, _data_past_due_at, _data_eligible_for_free_trial;
...
async function fetchJWKSFromBAPI(apiUrl, key, apiVersion) {
    ...
    if (!response.ok) {
        ...
        const invalidSecretKeyError = getErrorObjectByCode(json === null || json === void 0 ? void 0 : json.errors, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$HNJNM32R$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenVerificationErrorCode"].InvalidSecretKey);
...
var HandshakeService = class {
   ...
   */ async resolveHandshake() {
        ...
        if (this.authenticateContext.instanceType === "development" && ((error === null || error === void 0 ? void 0 : error.reason) === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$HNJNM32R$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenVerificationErrorReason"].TokenExpired || (error === null || error === void 0 ? void 0 : error.reason) === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$HNJNM32R$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenVerificationErrorReason"].TokenNotActiveYet || (error === null || error === void 0 ? void 0 : error.reason) === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$HNJNM32R$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenVerificationErrorReason"].TokenIatInTheFuture)) {
...
__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$S7Q4VL6O$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@clerk/backend/dist/chunk-S7Q4VL6O.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$chunk$2d$43A5F2IE$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@clerk/shared/dist/chunk-43A5F2IE.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$LWOXHF4E$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@clerk/backend/dist/chunk-LWOXHF4E.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@clerk/backend/dist/chunk-AR5UB427.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$HNJNM32R$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@clerk/backend/dist/chunk-HNJNM32R.mjs [app-client] (ecmascript)");
...
function encodeJwtData(value) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["base64url"].stringify(encoded, {
        pad: false
    });
}
async function signJwt(payload, key, options) {
    ...
    const encoder = new TextEncoder();
    const algorithm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCryptoAlgorithm"])(options.algorithm);
    if (!algorithm) {
        return {
            errors: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$HNJNM32R$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SignJWTError"]("Unsupported algorithm ".concat(options.algorithm))
            ]
        };
    }
    const cryptoKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["importKey"])(key, algorithm, "sign");
    ...
    try {
        const signature = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runtime"].crypto.subtle.sign(algorithm, cryptoKey, encoder.encode(firstPart));
        const encodedSignature = "".concat(firstPart, ".").concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["base64url"].stringify(new Uint8Array(signature), {
            pad: false
        }));
        return {
...
var hasValidSignature2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$P263NW7Z$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withLegacyReturn"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasValidSignature"]);
;
 //# sourceMappingURL=index.mjs.map
}),
]);

//# sourceMappingURL=node_modules_%40clerk_backend_dist_29433a0b._.js.map