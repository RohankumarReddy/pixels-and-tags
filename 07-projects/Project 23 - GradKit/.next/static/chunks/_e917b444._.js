...
function LearningFeedPage() {
    ...
    const handleGenerateFeed = async ()=>{
        ...
        try {
            ...
            const res = await fetch("/main/learning-feed", {
                method: "POST",
                headers: {
            ...
            if (!res.ok) {
                throw new Error("Failed to fetch feed from the server.");
            }
            ...
            if (data.feed && data.feed.length > 0) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("No results found for your query.");
                setFeed([]); // Ensure feed is empty
            }
        } catch (err) {
            console.error("Failed to generate feed:", err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err.message || "Failed to generate feed. Please try again.");
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=_e917b444._.js.map